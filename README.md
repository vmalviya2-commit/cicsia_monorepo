...
```sh
npx nx serve cicsia-angular-webclient-application
```

To create a production bundle:

```sh
npx nx build cicsia-angular-webclient-application
```

To see all available targets to run for a project, run:

```sh
npx nx show project cicsia-angular-webclient-application
```
